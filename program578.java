...
class Matrix
{
    ...
    public void SumEvenOdd()
    {
        ...
        for(i= 0; i < iRow; i++)
        {
            ...
            System.out.println("Addition of Even elemenets is:"+ iSumEven);
            System.out.println("Addition of Odd elemenets is:"+ iSumOdd);
        }    
    }
...
class program574
{
    public static void main(String Arg[])
    {
        ...
        iRet = mobj.RowSum();
        System.out.println("Diagonal element is: "+iRet);
