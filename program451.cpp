...
int main()
{
    ...
    obj.InsertFirst(51.14511);
    obj.InsertFirst(21.13425);
    obj.InsertFirst(11.1246238);

    obj.Display();
    iRet = obj.Count();
    cout<<"Number of elemensts are : "<<iRet<<endl;

    obj.InsertLast(101.241241);
    obj.InsertLast(111.12491);
    obj.InsertLast(121.58935);
    
    obj.Display();
    iRet = obj.Count();
    cout<<"Number of elemensts are : "<<iRet<<endl;

    obj.InsertAtPos(105.236498,5);
