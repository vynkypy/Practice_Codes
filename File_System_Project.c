...
void DisplayHelp()
{
    ...
    printf("strt: to display the information of file using name\n");
...
int CloseFileByName_1(char *name)
{
    int i =0;
...
void ls_file()
{
    ...
    printf("\n File Name\tInode Numbe\tFile Size\tLink Count\n");
    printf("-------------------------------------------------------\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count ==1 )
        {
            ...
            if(strcmp(command[0], "closeall")== 0)
            {
                CloseAllFile();
                printf("All files closed succssfully\n");
                continue;
            }
        ...
        else if(count == 2)
        {
            ...
            {
                ret = CloseFileByName_1(command[1]);
                if(ret == -1)
                {
                    printf("Error : There is no such file\n");
                }
        ...
        else if(count == 3)
        {
            if(strcmp(command[0], "create") == 0)
            {
                ...
                if(ret>= 0)
                {
                    printf("File is sucussfully created with the file descreptor: %d\n", ret);
                }
                if(ret>= -1)
                {
                    printf("Error: Incorrect Parameters\n");
            ...
            else if(strcmp(command[0],"open")== 0)
            {
                ...
                if(ret>= 0)
                {
                    printf("File is sucussfully opened with the file descreptor: %d\n", ret);
                }
                if(ret>= -1)
                {
                    printf("Error: Incorrect Parameters\n");
            ...
            else if(strcmp(command[0], "read") == 0)
            {
                ...
                if(ret == -4)
                {
                    printf("Error: Its is nott Regular File\n");
                }
                if(ret >0)
                {
                    write(2, ptr, ret);
